...
import FormationsBackground from "./backgrounds/FormationsBackground.jsx";
    ...
    return (
        <section id="formations" className="relative flex flex-col items-center py-16">
            ...
            <div ref={containerRef} className="relative w-full max-w-4xl">
                ...
                {formations.map((formation, index) => (
                    <div key={index} className={`relative flex items-center mb-16 ${index % 2 === 0 ? "justify-start" : "justify-end"}`}>
                        ...
                        <div
                            className="cursor-pointer bg-gray-800 text-white p-4 rounded-lg shadow-lg transition-transform duration-300 hover:scale-105 w-64"
            ...
            {selectedFormation && (
                ...
                >
                    <div className="bg-gray-900 p-6 rounded-lg w-4/5 md:w-1/2 lg:w-1/3 text-white relative" onClick={(e) => e.stopPropagation()}>
